...
order: 2
icons:
  - {file: applovin.png, alt: "AppLovin"}
tags: [AppLovin-MAX, UniTask, CSharp]
excerpt: "공통 모듈. 보상형 광고를 콜백 하나로 소비하는 싱글턴 설계 — 재화·버프·보상 2배·무료 소환에 세 프로젝트가 같은 호출부를 씁니다."
stats:
  - {k: 성격, v: "공통 모듈"}
  - {k: 적용, v: "3개 프로젝트"}
  - {k: 코드, v: "2개 파일"}
...
<div class="pf-panel">
  <table>
    ...
    <tr><td><strong>코드</strong></td><td><a href="https://github.com/mmmdong/portfolio-code/tree/main/common-modules/ad-manager">GitHub</a> — 광고 싱글턴 · 호출 래퍼 (2개 파일)</td></tr>
  </table>
</div>
